...
int _R = 1;              //(phase 2) 0 means spin when you see a red block and 1 means move it
...
direction_status direction = CLOCKWISE;   //-1 for AC 1 for C. (SET TO NONE FOR START UP)
